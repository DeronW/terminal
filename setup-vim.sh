...
echo -e "\033[47;30m cleanup .vimrc and .vim \033[0m"
rm -rf ~/.vimrc ~/.vim

# download Vundle first
echo -e "\033[47;30m 下载Vundle插件 \033[0m"
git clone https://github.com/VundleVim/Vundle.vim.git ~/.vim/bundle/Vundle.vim

# create vim config file
echo -e "\033[47;30m create .vimrc file \033[0m"
touch ~/.vimrc

echo -e "\033[47;30m download config content \033[0m"
...
echo -e "\033[47;30m start install plugin \033[0m"
vim +PluginInstall +qall # install vim plugin

echo -e "\033[32m Vim Plugin installed \033[0m"